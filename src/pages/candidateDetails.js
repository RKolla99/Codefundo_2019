    ...
    renderRow(item) {
        ...
        const itemRows = [
			<tr onClick={clickCallback} key={"row-data-" + item.id}>
			    <td align="center" style={{width:"100px"}}><img src = {`data:image/jpg;base64,${item.party_image}`} width = "20px" height="20px" alt =""/></td>
                ...
                <tr key={"row-expanded-" + item.id} style={{height:"auto"}}>
                    <td style={{width:"100px"}}>
                        <div style={{maxWidth:"100px"}}>
                            ...
                            <span style={{margin:"auto"}}><b> {item.party} </b></span>
                        </div>
                    </td>
                    <td >
                        <div style={{width:"100%",}} >
                            <span><b>Promises Kept:</b></span><br />
                            <span>&nbsp;&nbsp;{item.promises_kept}</span>
                            <br />
                            <span><b>Promises Made:</b></span> <br />
            ...
            <div>
                <div style={constituencyStyle}>
                    <div  style={constituencyInputStyle}>
                        ...
                        <Input id="const_id" />
                        <br />
                        <Button value="Submit" onClick={this.getCandidateList}> Submit </Button>
                    </div>
                    <br />
                    {(this.state.show_candidate_list) && (
                        <div id = "candidate_list" style={{width:"100%",}}>
                            <Table bordered hover style={{width:"100%", height:"auto", tableLayout:"fixed"}}>
